function RenameFiles(dirImgs)
    ...
    fnsAll=[dir([dirImgs slash '*.tif']);  dir([dirImgs slash '*.jpg']);  dir([dirImgs slash '*.png']); dir([dirImgs slash '*_pts.mat']); ]; 
    ...
    for numI=1:numel(fnsAll)
        ...
        if contains(fName, 'MPolipi')
            fName2=[ info.patName '_MTMALight.' info.ext]; 
